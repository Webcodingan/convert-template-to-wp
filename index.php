...
<section class="ve-hero">
    ...
    <div class="ve-hero-left">
        ...
        <p>VaultEdge delivers intelligent, data-driven investment strategies and personalised financial guidance to
            help you reach every milestone.</p>
        <div class="ve-hero-btns">
            <a href="<?php echo site_url('/services'); ?>" class="ve-btn-primary">Explore Services</a>
            <a href="<?php echo site_url('/about'); ?>" class="ve-btn-ghost">Learn More</a>
        </div>
        <!-- Quick Stats Row -->
    ...
    <div class="ve-hero-right">
        <div class="ve-hero-img-main bg-img" style="background-image:url(<?php echo get_template_directory_uri(); ?>/assets/img/bg-img/1.jpg);"></div>

        <div class="ve-hero-img-accent bg-img" style="background-image:url(<?php echo get_template_directory_uri(); ?>/assets/img/bg-img/3.jpg);"></div>
        <!-- Floating card -->
    ...
    <div class="container">
        ...
        <div class="ve-services-grid">
            <div class="ve-service-card wow fadeInUp" data-wow-delay="100ms">
                ...
                <a href="<?php echo site_url('/services'); ?>" class="ve-card-link">Learn more <i class="fa fa-long-arrow-right"></i></a>
            </div>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-12 col-lg-5">
                <div class="ve-whyus-img-wrap wow fadeInLeft" data-wow-delay="100ms">
                    <div class="ve-whyus-img-main bg-img" style="background-image:url(<?php echo get_template_directory_uri(); ?>/assets/img/bg-img/5.jpg);"></div>
            ...
            <div class="col-12 col-lg-7 wow fadeInRight" data-wow-delay="200ms">
                <div class="ve-whyus-content">
                    ...
                    <p>We combine deep financial expertise with cutting-edge technology to deliver outcomes that
                        consistently outperform the market — all while keeping your interests first.</p>
                    <div class="ve-checklist">
                        <div class="ve-check-item">
                            <i class="fa fa-check-circle"></i>
                            <div><strong>Personalised Strategy</strong>
                                <p>Every plan is crafted specifically for your unique financial situation.</p>
                            </div>
                        </div>
                        <div class="ve-check-item">
                            <i class="fa fa-check-circle"></i>
                            <div><strong>Transparent Pricing</strong>
                                <p>No hidden fees. Clear, upfront pricing on every product and service.</p>
                            </div>
                        </div>
                        <div class="ve-check-item">
                            <i class="fa fa-check-circle"></i>
                            <div><strong>24/7 Expert Support</strong>
                                <p>Our advisors are always available when you need guidance the most.</p>
                            </div>
                        </div>
                    </div>
                    <a href="<?php echo site_url('/about'); ?>" class="ve-btn-primary mt-30">Discover Our Story</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="ve-testi-grid">
            <div class="ve-testi-card wow fadeInUp" data-wow-delay="100ms">
                ...
                <div class="ve-testi-author">
                    <div class="ve-testi-avatar bg-img" style="background-image:url(<?php echo get_template_directory_uri(); ?>/assets/img/bg-img/32.jpg);"></div>
            ...
            <div class="ve-testi-card wow fadeInUp" data-wow-delay="250ms">
                ...
                <div class="ve-testi-author">
                    <div class="ve-testi-avatar bg-img" style="background-image:url(<?php echo get_template_directory_uri(); ?>/assets/img/bg-img/33.jpg);"></div>
            ...
            <div class="ve-testi-card wow fadeInUp" data-wow-delay="400ms">
                ...
                <p>"Switched from our old firm and couldn't be happier. Their tax advisory alone saved us thousands
                    in the first year."</p>
                <div class="ve-testi-author">
                    <div class="ve-testi-avatar bg-img" style="background-image:url(<?php echo get_template_directory_uri(); ?>/assets/img/bg-img/14.jpg);"></div>
...
<!-- ===== CTA BANNER ===== -->
<section class="ve-cta-banner bg-img" style="background-image:url(<?php echo get_template_directory_uri(); ?>/assets/img/bg-img/6.jpg);">
    ...
    <div class="container ve-cta-content">
        <div class="row align-items-center">
            ...
            <div class="col-12 col-lg-4 text-lg-right">
                <a href="<?php echo site_url('/contact'); ?>" class="ve-btn-white">Book Free Consultation</a>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-12 col-md-4 wow fadeInUp" data-wow-delay="100ms">
                <div class="ve-insight-card">
                    <div class="ve-insight-img bg-img" style="background-image:url(<?php echo get_template_directory_uri(); ?>/assets/img/bg-img/10.jpg);"></div>
                    <div class="ve-insight-body">
                        ...
                        <div class="ve-insight-meta">
                            ...
                            <a href="<?php echo site_url('/single-post'); ?>">Read More <i class="fa fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-4 wow fadeInUp" data-wow-delay="250ms">
                <div class="ve-insight-card">
                    <div class="ve-insight-img bg-img" style="background-image:url(<?php echo get_template_directory_uri(); ?>/assets/img/bg-img/11.jpg);"></div>
                    <div class="ve-insight-body">
            ...
            <div class="col-12 col-md-4 wow fadeInUp" data-wow-delay="400ms">
                <div class="ve-insight-card">
                    <div class="ve-insight-img bg-img" style="background-image:url(<?php echo get_template_directory_uri(); ?>/assets/img/bg-img/12.jpg);"></div>
                    <div class="ve-insight-body">
